...
#
# This example shows how to run JmproTicker in threaded mode.
# JmproTicker runs in separate thread and main thread is blocked to juggle between
...
# in your main thread while running JmproTicker in separate thread.
###############################################################################
