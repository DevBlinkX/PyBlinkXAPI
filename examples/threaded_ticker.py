...
#
# This example shows how to run BlinkXTicker in threaded mode.
# BlinkXTicker runs in separate thread and main thread is blocked to juggle between
...
# in your main thread while running BlinkXTicker in separate thread.
###############################################################################
