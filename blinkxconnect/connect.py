...
"""
    ...
    API wrapper for BlinkX Smart API REST APIs.
...
class BlinkXConnect(object):
    ...
    def __init__(self,
                 ...
                 disable_ssl=False):
        """
        Initialise a new BlinkX Smart API client instance.
        ...
        to the BlinkX Connect class initialisation for subsequent requests.
    ...
    def login_url(self):
        ...
        return "%s?api_key=%s&v=%s" % (self._default_login_uri, self.api_key, self.blinkx_header_version)
    ...
    def _request(self, route, method, url_args=None, params=None, is_json=False, query_params=None):
        ...
        # Custom headers
        headers = {
            "X-BlinkX-Version": self.blinkx_header_version,
