...
"""
    ...
    Websocket implementation for BlinkX ticker
...
class BlinkXTickerClientProtocol(WebSocketClientProtocol):
    """BlinkX ticker autobahn WebSocket protocol."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(BlinkXTickerClientProtocol, self).__init__(*args, **kwargs)
...
class BlinkXTickerClientFactory(WebSocketClientFactory, ReconnectingClientFactory):
    """Autobahn WebSocket client factory to implement reconnection and custom callbacks."""

    protocol = BlinkXTickerClientProtocol
    maxDelay = 5
    maxRetries = 10
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(BlinkXTickerClientFactory, self).__init__(*args, **kwargs)
...
class BlinkXTicker(object):
    """
    The WebSocket client for connecting to BlinkX Smart API's streaming quotes service.
    ...
    ---------------
        ...
        # Initialise
        kws = BlinkXTicker("your_api_key", "your_access_token")
    ...
    Auto reconnection is enabled by default and it can be disabled by passing `reconnect` param while initialising `BlinkXTicker`.
    ...
    def _create_connection(self, url, **kwargs):
        ...
        self.factory = BlinkXTickerClientFactory(url, **kwargs)
